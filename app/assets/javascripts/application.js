...
(function () {
  d3.timeline = function() {
    ...
    function timeline (gParent) {
      ...
      var gParentSize = gParent.nodes()[0].getBoundingClientRect();

      var gParentItem = d3.select(gParent.nodes()[0]);
      ...
      if (width > gParentSize.width) {
        ...
        // var zoom = d3.zoom().transform().rescaleX(xScale).on("zoom", move);
      ...
      var gSize = g.nodes()[0].getBoundingClientRect();
      setHeight();
      ...
      function setHeight() {
        if (!height && !gParentItem.attr("height")) {
          if (itemHeight) {
            ...
            d3.select(gParent.nodes()[0]).attr("height", height);
          } else {
